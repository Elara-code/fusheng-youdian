...
<style>body{margin:0;background:#090807;color:#f5ead5;font:16px system-ui;text-align:center}main{max-width:900px;margin:8vh auto;padding:24px}h1{font:42px Georgia;margin:0 0 8px}p{color:#b9aa91}.stage{position:relative;min-height:520px;margin:28px auto;display:grid;place-items:center;perspective:1200px;overflow:hidden}.stage:before{content:"";position:absolute;width:140%;height:140%;border-radius:50%;background:radial-gradient(circle,#fff5c4 0 3%,#e9b64f 12%,transparent 38%),repeating-conic-gradient(from 0deg,transparent 0 8deg,rgba(255,215,112,.35) 9deg 11deg,transparent 12deg 20deg);filter:blur(10px);opacity:0}.card{position:relative;width:100%;max-height:70vh;object-fit:contain;border-radius:18px;opacity:0;transform:rotateY(90deg) scale(.55);filter:brightness(.25);box-shadow:0 0 0 2px #ffe39a,0 0 0 8px #8b5d18,0 0 0 10px #ffe39a,0 0 0 18px #2b1b08,0 0 40px #d6ad68}.card.show{animation:cardOpen 2.8s cubic-bezier(.2,.8,.2,1) forwards}.stage.show{animation:sceneShake .42s 1.12s}.stage.show:before{animation:burst 2.8s ease-out forwards}.stage:after{content:"";position:absolute;inset:-20%;background:linear-gradient(110deg,transparent 35%,rgba(255,255,220,.98) 48%,transparent 60%);transform:translateX(-120%) rotate(8deg);pointer-events:none}.stage.show:after{animation:shine 2s 1.05s ease-out forwards}@keyframes cardOpen{0%{opacity:0;transform:rotateY(90deg) scale(.45);filter:brightness(.15) saturate(.5)}25%{opacity:1;transform:rotateY(-38deg) scale(1.08);filter:brightness(2.5) saturate(1.5)}48%{transform:rotateY(28deg) scale(1.03);filter:brightness(1.35)}68%{transform:rotateY(-12deg) scale(1.01)}100%{opacity:1;transform:rotateY(0) scale(1);filter:brightness(1);box-shadow:0 0 0 2px #ffe39a,0 0 0 8px #8b5d18,0 0 0 10px #ffe39a,0 0 0 18px #2b1b08,0 0 70px 12px #d6ad68}}@keyframes burst{0%{opacity:0;transform:scale(.15) rotate(0)}25%{opacity:1;transform:scale(1.2) rotate(35deg)}100%{opacity:.28;transform:scale(1.05) rotate(90deg)}}@keyframes shine{to{transform:translateX(120%) rotate(8deg)}}@keyframes sceneShake{25%{transform:translateX(-8px)}50%{transform:translateX(8px)}75%{transform:translateX(-4px)}}button,select{padding:12px 16px;border:1px solid #92794f;border-radius:999px;background:#d6ad68;color:#211a11;font-weight:700}select{margin-right:8px;background:#f5ead5}</style>
